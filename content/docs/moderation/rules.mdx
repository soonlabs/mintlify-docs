...
<Tip>Treat this as a starting point. After week one, review the [Audit Log](/docs/moderation/audit-log) and feed false positives / false negatives back into rule descriptions — precision scales with clarity.</Tip>
...
<Tip>Start with lenient rules (short mutes) and tighten over time. Review the [Audit Log](/docs/moderation/audit-log) regularly to check for false positives.</Tip>
